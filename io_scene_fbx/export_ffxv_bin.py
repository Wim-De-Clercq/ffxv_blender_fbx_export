...
def fbx_data_material_elements(root, mat, scene_data):
    ...
    if not skip_mat:
        ...
        elem_props_template_set(tmpl, props, "p_color", b"EmissiveColor",
                                mat.diffuse_color if mat.emit != 0.0 else (0.0, 0.0, 0.0))
        ...
        elem_props_template_set(tmpl, props, "p_color", b"TransparentColor",
                                (0.0, 0.0, 0.0) if mat.use_transparency else (1.0, 1.0, 1.0))
